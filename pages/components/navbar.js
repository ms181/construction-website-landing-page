  ...
  return (
    <>
      ...
      <nav className="bg-white shadow dark:bg-gray-800 border-b">
        <div className="container flex items-center justify-center p-3 gap-4 mx-auto text-gray-900 capitalize dark:text-gray-300">
          <a
            href="#"
            className="text-gray-800 transition-colors duration-300 transform dark:text-gray-200 flex"
          >
          ...
          <a
            href="#"
            className="border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 flex"
          >
            ...
            <div className="md:flex md:items-center md:gap-12">
              <nav aria-label="Site Nav" className="hidden md:block">
                <ul className="flex items-center gap-6 text-sm">
                  <li>
                    <a
                      className="text-gray-500 transition hover:text-gray-800 text-md"
                      href="#"
                    >
                      About
                    </a>
